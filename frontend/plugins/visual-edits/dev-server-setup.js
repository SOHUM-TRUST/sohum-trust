      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="visual-edit" -c user.email="info@sohumtrust.org" add "${targetFile}"`);
            execSync(`git -c user.name="visual-edit" -c user.email="info@sohumtrust.org" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
